<template>
  <div>
    ...
    <el-card>
      ...
      <!-- 用户列表区域 -->
      <el-table :data="JiaoYanList" border stripe :default-sort = "{prop: 'jid', order: 'ascending'}" id="JiaoYanList">
        <!-- stripe: 斑马条纹
        border：边框-->
        <el-table-column type="index" label="#"></el-table-column>
        <el-table-column prop="jid" label="教研室编号" sortable></el-table-column>
        <el-table-column prop="jname" label="教研室名称" sortable></el-table-column>
        <el-table-column prop="jcharge" label="教研室负责人" sortable></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async exportExcel () {
      ...
      await this.getJiaoYanList()
      this.$nextTick(function () {
        let wb = XLSX.utils.table_to_book(document.querySelector('#JiaoYanList'))
        /* get binary string as output */
        let wbout = XLSX.write(wb, { bookType: 'xlsx', bookSST: true, type: 'array' })
        try {
          FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), 'JiaoYanList.xlsx')
        } catch (e) {

<template>
  <div>
    ...
    <el-card>
      ...
      <!-- 用户列表区域 -->
      <el-table :data="DepartmentList" border stripe :default-sort = "{prop: 'did', order: 'ascending'}" id="DepartmentList">
        <!-- stripe: 斑马条纹
        border：边框-->
        <el-table-column type="index" label="#"></el-table-column>
        <el-table-column prop="did" label="系编号" sortable></el-table-column>
        <el-table-column prop="dname" label="系名称" sortable></el-table-column>
        <el-table-column prop="dcharge" label="系负责人" sortable></el-table-column>
        <el-table-column prop="cname" label="所属学院" sortable></el-table-column>
  ...
  methods: {
    ...
    async exportExcel () {
      ...
      this.$nextTick(function () {
        let wb = XLSX.utils.table_to_book(document.querySelector('#DepartmentList'))
        /* get binary string as output */
        let wbout = XLSX.write(wb, { bookType: 'xlsx', bookSST: true, type: 'array' })
        try {
          FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), 'DepartmentList.xlsx')
        } catch (e) {

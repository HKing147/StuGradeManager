<template>
  <div>
    ...
    <el-card>
      ...
      <!-- 用户列表区域 -->
      <el-table :data="TeacherClassCourseList" border stripe>
        <!-- stripe: 斑马条纹
        border：边框-->
        <el-table-column type="index" label="#"></el-table-column>
        <el-table-column prop="tid" label="教师编号"></el-table-column>
        <el-table-column prop="tname" label="教师姓名"></el-table-column>
        <el-table-column prop="claname" label="班级名"></el-table-column>
        <el-table-column prop="couname" label="课程名"></el-table-column>
